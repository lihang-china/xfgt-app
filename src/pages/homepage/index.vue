		...
		<ui-card :title="'今日排班信息'">
			<view class="center-bottom ">
				<view class="bottom-icon">
					<u-tag :text="wordData.info" shape="circle" size="mini"></u-tag>
					<text>{{wordData.data.startDate}} —— {{wordData.data.endDate}}</text>
				</view>
				<view>
			...
			<view class="bottom-notice">
				<u-notice-bar color="#0068f8" bgColor="#0068f801" :text="wordData.data.desc" speed="80">
				</u-notice-bar>
			</view>
		</ui-card>
